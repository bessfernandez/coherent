...
coherent.VideoLegacy= Class.create(coherent.View, {
    ...
    constructor: function(view, parameters, videoElement)
    {
        ...
        this._object = findElement( view, "object", coherent.Browser.IE ? 1 : 0 );
        ...
        if (videoElement.getAttribute('src') && !coherent.Browser.MobileSafari) {        
    ...
    play: function()
    {
        if (this._canPlay || coherent.Browser.MobileSafari) {
